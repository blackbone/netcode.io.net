namespace NetcodeIO.NET.Utils.Crypto
{
        ...
        : IMac
    {
        ...
        private readonly byte[] currentBlock = new byte[BlockSize];
        ...
        public void Init(ICipherParameters parameters)
        {
            ...
            if (cipher != null)
            {
                if (parameters is not ParametersWithIv ivParams)
            ...
            if (parameters is not KeyParameter keyParams)
        ...
        private void SetKey(byte[] key, byte[] nonce)
        {
            ...
            if (cipher != null && nonce is not { Length: BlockSize })
        ...
        public string AlgorithmName => cipher == null ? "Poly1305" : "Poly1305-" + cipher.AlgorithmName;
        ...
        public void BlockUpdate(byte[] input, int inOff, int len)
        {
            ...
            while (len > copied)
            {
                ...
                var toCopy = System.Math.Min(len - copied, BlockSize - currentBlockOffset);
        ...
        private void ProcessBlock()
        {
            if (currentBlockOffset < BlockSize)
            {
                ...
                for (var i = currentBlockOffset + 1; i < BlockSize; i++) currentBlock[i] = 0;
            }
            ...
            if (currentBlockOffset == BlockSize) h4 += 1 << 24;
