...
namespace Netcode.io.OLD.Spawning
{
    /// <summary>
    ...
    public class NetworkSpawnManager
    {
        ...
        /// </summary>
        public readonly Dictionary<ulong, Dictionary<ulong, NetworkObject>> OwnershipToObjectsTable = new();
        ...
        /// the NetworkObject
        /// </summary>
        private Dictionary<ulong, ulong> m_ObjectToOwnershipTable = new();
        ...
        internal NetworkObject CreateLocalNetworkObject(NetworkObject.SceneObject sceneObject)
        {
            ...
            if (!NetworkManager.NetworkConfig.EnableSceneManagement || !sceneObject.IsSceneObject)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        networkObject = NetworkManager.Scene.Instantiate(networkPrefabReference).GetComponent<NetworkObject>();
                        networkObject.NetworkManagerOwner = NetworkManager;
                    }
                }
            }
            ...
            if (networkObject != null)
            {
                ...
                { 
                    NetworkManager.DontDestroyOnLoad(networkObject.gameObject);
                }
            }
        ...
        private void SpawnNetworkObjectLocallyCommon(NetworkObject networkObject, ulong networkId, bool sceneObject, bool playerObject, ulong ownerClientId, bool destroyWithScene)
        {
            ...
            NetworkManager.DeferredMessageManager.ProcessTriggers(DeferredMessageManager.TriggerType.OnSpawn, networkId);
...
#else
            var networkObjects = NetworkManager.FindObjectsOfType<NetworkObject>().Where((c) => c.IsSceneObject != null && c.IsSceneObject == true);
#endif
...
#else
            var networkObjects = NetworkManager.Scene.FindObjectsOfType<NetworkObject>();
#endif
        ...
        internal void ServerSpawnSceneObjectsOnStartSweep()
        {
            ...
            var networkObjects = UnityEngine.Object.FindObjectsByType<NetworkObject>(FindObjectsSortMode.InstanceID);
#else
            var networkObjects = Array.Empty<NetworkObject>(); //UnityEngine.Object.FindObjectsOfType<NetworkObject>();
#endif
        ...
        internal void OnDespawnObject(NetworkObject networkObject, bool destroyGameObject)
        {
            ...
            if (!NetworkManager.ShutdownInProgress && true)
            {
        ...
        internal void UpdateObservedNetworkObjects(ulong clientId)
        {
            foreach (var networkObject in SpawnedObjectsList)
            {
                ...
                {
                    if (networkObject.CheckObjectVisibility(clientId))
                        networkObject.Observers.Add(clientId);
                    else if (networkObject.Observers.Contains(clientId))
