...
namespace Netcode.io.OLD.NetworkVariable.Collections
{
    /// <summary>
    ...
    {
        private List<T> m_List = new(64);
        private List<NetworkListEvent<T>> m_DirtyEvents = new(64);
        ...
        internal void MarkNetworkObjectDirty()
        {
            ...
            {
                this.LogWarning($"NetworkList is written to, but doesn't know its NetworkBehaviour yet. " +
        ...
        public override void WriteField(FastBufferWriter writer)
        {
            ...
            {
                var tmp = m_List[i];
                NetworkVariableSerialization<T>.Write(writer, ref tmp);
                m_List[i] = tmp;
            }
        }
