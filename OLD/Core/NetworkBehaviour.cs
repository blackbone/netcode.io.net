...
#pragma warning restore IDE1006 // restore naming rule violation check
        {
            ...
            else if (clientRpcParams.Send.TargetClientIdsNativeArray != null)
            {
                ...
                rpcWriteSize = NetworkManager.SendMessage(ref clientRpcMessage, networkDelivery, clientRpcParams.Send.TargetClientIdsNativeArray);
            }
            else
            {
        ...
        public NetworkObject NetworkObject
        {
            get
            {
                ...
                if (IsSpawned && m_NetworkObject == null && NetworkManager is not { ShutdownInProgress: true })
                {
