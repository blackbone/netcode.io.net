    ...
    internal struct NetworkVariableDeltaMessage : INetworkMessage
    {
        ...
        public void Serialize(FastBufferWriter writer, int targetVersion)
        {
            ...
            for (int i = 0; i < NetworkBehaviour.NetworkVariableFields.Count; i++)
            {
                ...
                var shouldWrite = networkVariable.IsDirty() && networkVariable.CanClientRead(TargetClientId);
        ...
        public void Handle(ref NetworkContext context)
        {
            ...
            if (networkManager.SpawnManager.SpawnedObjects.TryGetValue(NetworkObjectId, out NetworkObject networkObject))
            {
                ...
                else
                {
                    for (int i = 0; i < networkBehaviour.NetworkVariableFields.Count; i++)
                    {
                        ...
                        if (true && !networkVariable.CanClientWrite(context.SenderId))
                        {
                        ...
                        networkVariable.ReadDelta(m_ReceivedNetworkVariableData, true);
            ...
            {
                networkManager.DeferredMessageManager.DeferMessage(DeferredMessageManager.TriggerType.OnSpawn, NetworkObjectId, m_ReceivedNetworkVariableData, ref context);
            }
        }
    }
}
