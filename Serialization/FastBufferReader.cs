...
using Netcode.io.OLD.Unity.Collections.LowLevel.Unsafe;

namespace Netcode.io.Serialization
{
    /// <summary>
    ...
    public struct FastBufferReader : IDisposable
    {
        ...
        public unsafe FastBufferReader(Span<byte> buffer, Allocator copyAllocator, int length = -1, int offset = 0, Allocator internalAllocator = Allocator.Temp)
        {
